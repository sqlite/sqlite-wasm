// Generated by scripts/split-bundler-friendly-vfss.mjs from sqlite3-bundler-friendly.mjs.
...
const sqlite3BundlerFriendlyInstallOptionalInitializers = (slot) => {
...
/* Optional initializer slot removed by scripts/split-bundler-friendly-vfss.mjs: worker1 */
sqlite3BundlerFriendlyInstallOptionalInitializers('worker1');

/* Optional initializer slot removed by scripts/split-bundler-friendly-vfss.mjs: helper */
sqlite3BundlerFriendlyInstallOptionalInitializers('helper');

/* Optional initializer slot removed by scripts/split-bundler-friendly-vfss.mjs: vtab */
sqlite3BundlerFriendlyInstallOptionalInitializers('vtab');

/* Optional initializer slot removed by scripts/split-bundler-friendly-vfss.mjs: kvvfs */
sqlite3BundlerFriendlyInstallOptionalInitializers('kvvfs');

/* Optional initializer slot removed by scripts/split-bundler-friendly-vfss.mjs: opfsShared */
sqlite3BundlerFriendlyInstallOptionalInitializers('opfsShared');

/* Optional initializer slot removed by scripts/split-bundler-friendly-vfss.mjs: opfs */
sqlite3BundlerFriendlyInstallOptionalInitializers('opfs');

/* Optional initializer slot removed by scripts/split-bundler-friendly-vfss.mjs: sahpool */
sqlite3BundlerFriendlyInstallOptionalInitializers('sahpool');

/* Optional initializer slot removed by scripts/split-bundler-friendly-vfss.mjs: opfsWl */
sqlite3BundlerFriendlyInstallOptionalInitializers('opfsWl');
/*
  2022-07-22

...
self.onmessage = async () => {
  try {
    ...
    let db = new opfsSahPool.OpfsSAHPoolDb('/test-sahpool-treeshakable-worker.sqlite3');
    ...
    try {
      ...
      db = new opfsSahPool.OpfsSAHPoolDb('/test-sahpool-treeshakable-worker.sqlite3');
      ...
      try {
        new opfsSahPool.OpfsSAHPoolDb('/test-sahpool-treeshakable-worker.sqlite3');
